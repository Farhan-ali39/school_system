                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="class_id" id="class_id" style="display: inline-block;">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="section_id" id="section_id" style="display: inline-block;">
        ...
        $(document).on('change', '#section_id', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#search_box').append(data.optionList);
                }
            });
        });
